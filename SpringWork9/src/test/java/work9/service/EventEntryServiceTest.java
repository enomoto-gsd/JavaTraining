...
public class EventEntryServiceTest {
	...
	public void test001() {
		List<Participant> eventList = eventEntryService.selectEntryParticipant(1);
	...
	public void test002() {
		List<Participant> eventList = eventEntryService.selectEntryParticipant(3);
	...
	public void test003() {
		...
		// DBに登録された情報を取得
		List<Participant> participantList = eventEntryService.selectEntryParticipant(1);
